...
async def generate_report_plan(state: ReportState, config: RunnableConfig):
    ...
    structured_llm = writer_model.with_structured_output(Queries, method='function_calling')
    ...
    structured_llm = planner_llm.with_structured_output(Sections, method='function_calling')
    ...
    if planner_model == "claude-3-7-sonnet-latest":
        ...
        reflection_model = init_chat_model(model=planner_model,
                                           ...
                                           thinking={"type": "enabled",
                                                     "budget_tokens": 16_000}).with_structured_output(Feedback, method='function_calling')
    else:
        reflection_model = init_chat_model(model=planner_model,
                                           model_provider=planner_provider).with_structured_output(Feedback, method='function_calling')
    # Generate feedback
