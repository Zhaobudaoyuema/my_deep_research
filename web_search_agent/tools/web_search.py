...
from web_search_agent.tools.base import ToolResult, BaseTool
from web_search_agent.tools.search.baidu_search import BaiduSearchEngine
from web_search_agent.tools.search.base import WebSearchEngine, SearchItem
from web_search_agent.tools.search.bing_search import BingSearchEngine
from web_search_agent.tools.search.duckduckgo_search import DuckDuckGoSearchEngine
from web_search_agent.tools.search.google_search import GoogleSearchEngine
...
class WebSearch(BaseTool):
    ...
    _search_engine: dict[str, WebSearchEngine] = {
        ...
        "google_serper": GoogleSearchTool(provider='serper'),
    }
    ...
    async def _try_all_engines(
        self, query: list, num_results: int, search_params: Dict[str, Any]
    ) -> List[SearchResult]:
    ...
    async def _perform_search_with_engine(
        ...
        """Execute search with the given engine and parameters asynchronously."""
        return await engine.perform_search(
            query,
